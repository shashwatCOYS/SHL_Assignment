...
**Token budget**: ~1.8K input + ~400 output per call. Gemini free tier handles eval turns comfortably.
...
Render free tier. `render.yaml` configures build and start. Cold start ~2 minutes (within evaluator allowance). API URL: https://shl-recommender-uxfj.onrender.com
